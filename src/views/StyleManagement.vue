...
## 风格锚点
统一使用XX为主色调，XX作为强调色，保持现代简洁的信息图风格，适合XX场景

## 配色
- 主色：颜色名 (#RRGGBB) - 用于标题、重点元素
- 强调色：颜色名 (#RRGGBB) - 用于图标、高亮、按钮
- 背景色：颜色名 (#RRGGBB) - 页面底色
- 卡片色：颜色名 (#RRGGBB) - 信息模块背景
- 文本色：颜色名 (#RRGGBB) - 正文内容
- 辅助文本：颜色名 (#RRGGBB) - 说明文字、标签

## 背景基调
描述背景的底色和层次感，如：浅色干净背景，柔和渐变，适合信息展示

## 标题样式
描述标题的字体、字重、层级，如：粗体标题，层级清晰，数字醒目

## 卡片样式
描述卡片的圆角、阴影、质感，如：圆角 8-12px，轻微阴影，模块化布局

## 图标样式
描述图标的风格和颜色，如：线性图标，主色调，简洁现代

## 线条样式
描述连接线的风格，如：简洁连接线，箭头指示，关系清晰
